    ...
    export default {
        ...
        methods: {
            ...
            rotateElement: function (x1, y1, x2, y2) {
              ...
              this.elmAngle = angle1 - angle2 + this.lastAngle;
			...
			//
            //     // 角度
            //     this.elmAngle = (Math.ceil(180 / (Math.PI / radina)) + Math.abs(this.lastAngle)) % 360;
			//
            //     //如果在初始滑动位置与中点的连线的下边 就需要加 180度
            //     //计算直线方程斜率，因为坐标原点为屏幕左上角，整个页面位于坐标系中的第四象限，x为正，y为负
            //     let k = (-this.rotateBeginY - (-this.y0)) / (this.rotateBeginX - this.x0)
            //     console.log('rotateBegin:(',this.rotateBeginX.toFixed(2),',', -this.rotateBeginY.toFixed(2),')');
            //     console.log('x0,y0 :(',this.x0.toFixed(2),',', -this.y0.toFixed(2),')');
            //     console.log('endPoint:(',endPointX.toFixed(2),',', -endPointY.toFixed(2),')');
            //     console.log('k: ', k);
            //     console.log('计算y: ', k * (endPointX - this.x0) - this.y0);
            //     if (this.rotateBeginX >= this.x0) {
            //         if (-endPointY >= k * (endPointX - this.x0) - this.y0) {
            //             console.log('1111111111111111')
            //             this.elmAngle =  - this.elmAngle;
            //         }
            //     } else {
            //         if (-endPointY < k * (endPointX - this.x0) - this.y0) {
            ...
            //         }
            //     }
            //     console.log('====>', this.lastAngle, this.elmAngle)
			//
			//
            // }
        },
